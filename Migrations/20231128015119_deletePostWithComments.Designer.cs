...
namespace SpaceBook.Migrations
{
    ...
    [Migration("20231128015119_deletePostWithComments")]
    partial class deletePostWithComments
    {
            ...
            modelBuilder.Entity("SpaceBook.Models.Comment", b =>
                {
                    ...
                    b.Property<int>("UserGeneratedSpaceContentId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserGeneratedSpaceContentId");
            ...
            modelBuilder.Entity("SpaceBook.Models.Comment", b =>
                {
                    b.HasOne("SpaceBook.Models.UserGeneratedSpaceContent", "UserGeneratedSpaceContent")
                        .WithMany("Comments")
                        .HasForeignKey("UserGeneratedSpaceContentId")
